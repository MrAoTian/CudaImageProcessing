...
MinMaxFilter::MinMaxFilter(/* args */)
{
}
...
void MinMaxFilter::init(int width_, int height_)
{
    width = width_;
    height = height_;
    this->allocMemory();
...
void MinMaxFilter::run(unsigned char* src, unsigned char* dst, int ksz, int mode)
{
    // Compute min/max set
